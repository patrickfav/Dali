...
public class SimpleBlurFragment extends Fragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		BlurBuilder.JobDescription jobDescription3 = dali.load(R.drawable.test_img1).blurRadius(12).downScale(2).reScaleIfDownscaled().into(iv3);
		...
		BlurBuilder.JobDescription jobDescription4 = dali.load(R.drawable.test_img1).blurRadius(8).downScale(4).brightness(-40).reScaleIfDownscaled().into(iv4);
